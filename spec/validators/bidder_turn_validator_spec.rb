...
describe BidderTurnValidator, type: :validator do
  fixtures :all
  ...
  subject(:validator)    { BidderTurnValidator.new(service) }
  ...
  describe "#player_is_next_to_bid" do
      ...
      context "when the incorrect player tries to bid" do
        3.times do |n|
          ...
          it "has the correct 'not your turn' error" do
            expect(validator.errors[:base]).to include(NOT_YOUR_TURN_TO_BID_ERROR)
          end
        end
      end
    end
    ...
    context "when is the fourth bid of the round" do
      ...
      context "when the first player passed" do
        ...
        context "and the second player passed" do
          ...
          # TODO this is now validated by bidding_is_open, so can't be tested here..
          ...
          #         expect(validator.errors[:base]).to include(BIDDING_FINISHED_ERROR)
          #       end
          #     end
          #   end
          # end
